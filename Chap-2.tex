...
\end{exe}
\begin{pf}
    For two arbitrary vectors $\lvert\psi\rangle$ and $\lvert\varphi\rangle$,
    \begin{align}
        \left(\left(\sum_ia_iA_i\right)^{\dagger}\lvert\psi\rangle,\lvert\varphi\rangle\right)=\left(\lvert\psi\rangle,\sum_ia_iA_i\lvert\varphi\rangle\right)=\sum_ia_i(\lvert\psi\rangle,A_i\lvert\varphi\rangle)=\sum_ia_i(A_i^{\dagger}\lvert\psi\rangle,\lvert\varphi\rangle)=\left(\sum_ia_i^*A_i^{\dagger}\lvert\psi\rangle,\lvert\varphi\rangle\right).
    \end{align}
    Due to the arbitrariness of $\lvert\psi\rangle$ and $\lvert\varphi\rangle$, we have
    \begin{align}
        \left(\sum_ia_iA_i\right)^{\dagger}=\sum_ia_i^*A_i^{\dagger}.
    \end{align}
\end{pf}
