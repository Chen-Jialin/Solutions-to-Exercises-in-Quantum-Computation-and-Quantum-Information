...
\begin{sol}
    Suppose an arbitrary qubit unitary operator is
        ...
        \begin{align}
            aa^*+bb^*=&e^{i(\alpha-\beta/2-\delta/2)}\cos\frac{\gamma}{2}e^{-i(\alpha-\beta/2-\delta/2)}\cos\frac{\gamma}{2}-e^{i(\alpha-\beta/2+\delta/2)}\sin\frac{\gamma}{2}\left[-e^{i(\alpha-\beta/2+\delta/2)}\sin\frac{\gamma}{2}\right]=\cos^2\frac{\gamma}{2}+\sin^2\frac{\gamma}{2}=1,\\
            cc^*+dd^*=&e^{i(\alpha+\beta/2-\delta/2)}\sin\frac{\gamma}{2}e^{-i(\alpha+\beta/2-\delta/2)}\sin\frac{\gamma}{2}+e^{i(\alpha+\beta/2+\delta/2)}\cos\frac{\gamma}{2}e^{-i(\alpha+\beta/2+\delta/2)}\cos\frac{\gamma}{2}=\sin^2\frac{\gamma}{2}+\sin^2\frac{\gamma}{2}=1,\\
            \notag ac^*+bd^*=&e^{i(\alpha-\beta/2-\delta/2)}\cos\frac{\gamma}{2}e^{-i(\alpha+\beta/2-\delta/2)}\sin\frac{\gamma}{2}-e^{i(\alpha-\beta/2+\delta/2)}\sin\frac{\gamma}{2}e^{-i(\alpha+\beta/2+\delta/2)}\cos\frac{\gamma}{2}=e^{-\beta}\cos\frac{\gamma}{2}-e^{-\beta}\cos\frac{\gamma}{2}\\
            =&0.
        \end{align}
...
\begin{sol}
    ...
    For arbitrary $a$, $b$, $c$, $d$ such that $U$ is unitary, let
    \begin{align}
